      ...
      <div className="leftbarWrapperHome">
          ...
          <div className="ProfileCard">
            ...
            <div className="Rank">
              <div className="RankLogo">
                <img
                  src={rankImg[Math.floor(props.user.rank / 100)]}
                  alt="rank-logo"
                  className="RankImg"
                />
              </div>
              <div className="Elo">
                <span className="RankName">
                  {ranks[Math.floor(props.user.rank / 100)]}
                </span>
                <span className="RankScore">
                  {props.user.rank}/
                  {100 - (props.user.rank % 100) + props.user.rank}
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="courseAds-container">
          ...
          <div className="Course1">
            ...
            <a
              href={courseLinks[idx1]}
              target="_blank"
              rel="noopener noreferrer"
            >
              <h3 className="courseName">{courseTi[idx1]}</h3>
            </a>
          </div>

          <div className="Course2">
            <img src={hackImg[idx2]} alt="C-logo2" className="courseLogo" />
            <a href={hackLinks[idx2]} target="_blank" rel="nopener noreferrer">
              <h3 className="courseName">{hackTitle[idx2]}</h3>
            </a>
          </div>
        </div>
        <hr
        ...
        <div className="gitLeftBar">
          <a href="https://github.com/" rel="noopener noreferrer">
            {" "}
            <div className="gitCourse">
              <h3 className="gitHubButton">
