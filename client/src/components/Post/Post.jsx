...
export default function Post(props) {
  ...
  console.log(props);
  const [clickedAgain, setClickedAgain] = useState(
    user.savedArray.includes(props.details._id)
  );
  const [clicked, setClicked] = useState(
    props.details.likes.includes(user._id)
  );
      ...
      <div className="details">
        ...
        <div className="details-text">
          ...
          <div className="postedon">
            Posted on {new Date(props.details.createdAt).toLocaleString()}
          </div>
        </div>
