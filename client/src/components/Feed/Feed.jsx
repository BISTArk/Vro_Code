...
function Feed(props) {
  ...
  return (
    <div className="feed">
      {user._id === props.user._id && !props.bookmarks ? (
          ...
          <div className="post-btns">
            <div className="post-upload">
              <div className="upload-option" onClick={switchMode}>
                <FontAwesomeIcon
                  icon={!code ? faCode : faFont}
                  className="codeIcon"
                />
                {code ? (
                  <label htmlFor="postCode" style={{ cursor: "pointer" }}>
                    {" "}
                    Text
                  </label>
                ) : (
              ...
              <div className="upload-option" style={{ cursor: "pointer" }}>
                ...
                <label htmlFor="postImg" className="ImageUploadButton">
                  {" "}
                  Image
                </label>
                <input
